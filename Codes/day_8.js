...
Cada 10 regalos del mismo tipo se empaquetan en una caja,
 representada por {x}. Por ejemplo, 20 regalos tipo a se empaquetan en 2 cajas así: {a}{a}.
...
Los regalos luego se colocan en el siguiente orden:
 palés, cajas y bolsas. Y los regalos aparecen en el mismo orden que la cadena de entrada.
...
function organizeGifts(gifts) {
  ...
  const characters = gifts.split(/[\W\d]+/).filter(Boolean)
